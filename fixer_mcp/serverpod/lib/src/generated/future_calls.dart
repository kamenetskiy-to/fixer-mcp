...
import 'package:fixer_dashboard_server/src/generated/codex_turn_persist_request.dart'
    as _i2;
import 'dart:async' as _i3;
import '../future_calls/codex_turn_future_call.dart' as _i4;
...
class FutureCalls extends _i1.FutureCallDispatch<_FutureCallRef> {
  ...
  void initialize(
    ...
    var registeredFutureCalls = <String, _i1.FutureCall>{
      'CodexTurnInvokeDetachedSessionFutureCall':
          CodexTurnInvokeDetachedSessionFutureCall(),
      'CodexTurnInvokeFutureCall': CodexTurnInvokeFutureCall(),
    };
...
class _FutureCallRef {
  ...
  late final codexTurn = _CodexTurnFutureCallDispatcher(_invokeFutureCall);
}

class _CodexTurnFutureCallDispatcher {
  _CodexTurnFutureCallDispatcher(this._invokeFutureCall);

  final _InvokeFutureCall _invokeFutureCall;

  Future<void> invokeDetachedSession(_i2.CodexTurnPersistRequest request) {
  ...
  Future<void> invoke(_i2.CodexTurnPersistRequest? object) {
    return _invokeFutureCall(
      'CodexTurnInvokeFutureCall',
      object,
    );
  }
}
...
class CodexTurnInvokeDetachedSessionFutureCall
    extends _i1.FutureCall<_i2.CodexTurnPersistRequest> {
  @override
  _i3.Future<void> invoke(
    _i1.Session session,
    _i2.CodexTurnPersistRequest? request,
  ) async {
    await _i4.CodexTurnFutureCall().invokeDetachedSession(
      session,
      request!,
    );
  }
...
class CodexTurnInvokeFutureCall
    extends _i1.FutureCall<_i2.CodexTurnPersistRequest> {
  @override
  _i3.Future<void> invoke(
    _i1.Session session,
    _i2.CodexTurnPersistRequest? object,
  ) async {
    await _i4.CodexTurnFutureCall().invoke(
      session,
      object,
    );
  }
