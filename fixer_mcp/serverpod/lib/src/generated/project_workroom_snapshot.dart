...
import 'package:fixer_dashboard_server/src/generated/protocol.dart' as _i7;

/// Consistent initial Project Workroom read model and its journal watermark.
@_i1.immutable
abstract class ProjectWorkroomSnapshot
  ...
  Map<String, dynamic> toJsonForProtocol() {
    return {
      ...
      'protocol_version': protocolVersion,
      'watermark_seq': watermarkSeq,
      'threads': threads.toJson(valueToJson: (v) => v.toJsonForProtocol()),
      if (selectedThreadId != null) 'selected_thread_id': selectedThreadId,
      'turns': turns.toJson(valueToJson: (v) => v.toJsonForProtocol()),
      if (activeSurface != null)
        'active_surface': activeSurface?.toJsonForProtocol(),
      'hands_actor_id': handsActorId,
      'hands_display_name': handsDisplayName,
      'hands_authority_state': handsAuthorityState,
      'hands_default_lane': handsDefaultLane,
      'hands_lanes': handsLanes.toJson(
        valueToJson: (v) => v.toJsonForProtocol(),
      ),
      'hands_mailbox': handsMailbox.toJson(
        valueToJson: (v) => v.toJsonForProtocol(),
      ),
      if (activeInstruction != null)
        'active_instruction': activeInstruction?.toJsonForProtocol(),
      'capabilities': capabilities.toJson(),
    };
  }
